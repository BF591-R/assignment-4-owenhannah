...
caption_4 <- 'Variance explained for each principal component (bars) and the cumulative sum (line)'
caption_5 <- 'BiPlot of variance of PC1 and PC2'
caption_8 <- 'Heatmap of normalized intensity values for diffentially expressed probes'
```
...
ggplot(variance_tibble) + 
  geom_bar(aes(x=principal_components, y=variance_explained), stat='identity') +
  geom_line(aes(x=principal_components, y=cumulative), group =1) +
  geom_point(aes(x=principal_components, y=cumulative), group =1 ) +
  theme(
